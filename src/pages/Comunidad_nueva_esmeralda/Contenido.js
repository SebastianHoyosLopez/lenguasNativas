      ...
      <Grid sx={{ padding: '3rem', textAlign: 'justify' }}>
        <Typography variant="p" fontSize={25}>
          <p>
            <div>
              <div>
                <span>*Seguimiento a aprendices*</span>
              </div>
              <br />
              <div>
                <span>
                  El proceso de formaci&oacute;n cont&oacute; con una duraci&oacute;n de 36 sesiones (140 horas en total). Las sesiones se realizaron los lunes, mi&eacute;rcoles y viernes, en jornadas
                  de cuatro horas, de 8:00 am a 12:00 m. El plan de formaci&oacute;n se estructur&oacute; en tres m&oacute;dulos, en el siguiente orden: 1. Fonolog&iacute;a y vocabulario b&aacute;sico
                  de la lengua
                </span>
                <span>`p~~i&iacute;~~nemuna`</span>
                <span>, con &eacute;nfasis en el estudio del alfabeto vocales y consonantes; 2. interacciones y situaciones b&aacute;sicas de la lengua </span>
                <span>`p~~i&iacute;~~nemuna`</span>
                <span>, con &eacute;nfasis en el vocabulario de la maloca o </span>
                <span>*baaja*</span>
                <span> y de la chagra o </span>
                <span>`*um~~i~~he*`</span>
                <span>; 3. cantos de arrullo y de la fiesta </span>
                <span>`*ap&uacute;jko*`</span>
                <span>
                  ; para este &uacute;ltimo n&uacute;cleo se recogieron cinco cantos durante el dise&ntilde;o del plan de formaci&oacute;n, pero, como ya se dijo, no fue posible llevarlo a cabo por
                  falta de tiempo. Cada n&uacute;cleo tem&aacute;tico del taller de lengua
                </span>
                <span>`p~~&iacute;&iacute;~~nemuna`</span>
                <span>
                  se estim&oacute; de una duraci&oacute;n aproximada de 12 sesiones (46 horas), las cuales suman 36 sesiones (140 horas) en la totalidad del curso. Lograron culminar y certificarse
                  satisfactoriamente en la formaci&oacute;n del taller escuela un total de 15 aprendices.
                </span>
              </div>
              <br />
              <div>
                <span>*Seguimiento acad&eacute;mico (contenido, actividades, metodolog&iacute;a*</span>
              </div>
              <br />
              <div>
