    ...
    <>
      ...
      >
        <Typography variant="p" fontSize={25}>
          ...
          Boyacá aportó su sede, El Claustro de Santa Clara La Real, en comodato. Se caracteriza por su enfoque en la diferencia que permite, con la metodología aprender haciendo, la implementación de
