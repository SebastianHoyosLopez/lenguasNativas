    ...
    <Box sx={{ padding: "0 8px 0 8px"}}>
      ...
      <Box sx={{padding: "3rem", textAlign: "justify"}}>
        <Typography variant="p" fontSize={25}>
          ...
          talign='justify'écnicos laborales de un año y cursos complementarios. En estos programas y cursos se vincula a portadores de saberes técnicos como estrategia de valoración, protección y salvaguardia de sus
